namespace ESS.Migrations
{
    ...
    public partial class AddReimbAndReimbConvTables : DbMigration
    {
        public override void Up()
        {
            ...
            AddForeignKey("dbo.ApplReleaseStatus", new[] { "Reimbursements_YearMonth", "Reimbursements_ReimbId" }, "dbo.Reimbursements", new[] { "YearMonth", "ReimbId" });
        }
        
        public override void Down()
        {
            DropForeignKey("dbo.Reimbursements", new[] { "ReleaseGroupCode", "ReleaseStrategy" }, "dbo.ReleaseStrategies");
            ...
            DropForeignKey("dbo.ApplReleaseStatus", new[] { "Reimbursements_YearMonth", "Reimbursements_ReimbId" }, "dbo.Reimbursements");
