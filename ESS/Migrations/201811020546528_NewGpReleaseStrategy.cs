namespace ESS.Migrations
{
    ...
    public partial class NewGpReleaseStrategy : DbMigration
    {
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.GpReleaseStrategyLevels", new[] { "ReleaseGroupCode", "GpReleaseStrategy" }, "dbo.GpReleaseStrategies");
            ...
            DropForeignKey("dbo.GpReleaseStrategies", new[] { "CompCode", "WrkGrp", "UnitCode", "DeptCode", "StatCode" }, "dbo.Stations");
            DropForeignKey("dbo.GpReleaseStrategies", "ReleaseGroupCode", "dbo.ReleaseGroups");
            DropForeignKey("dbo.GpReleaseStrategies", new[] { "CompCode", "WrkGrp", "UnitCode", "DeptCode" }, "dbo.Departments");
