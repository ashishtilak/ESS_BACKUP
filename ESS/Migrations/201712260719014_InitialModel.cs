    ...
    public partial class InitialModel : DbMigration
    {
        public override void Up()
        {
            CreateTable(
                ...
                .PrimaryKey(t => new { t.YearMonth, t.ReleaseGroupCode, t.ApplicationId, t.ReleaseStrategy, t.ReleaseStrategyLevel })
                .ForeignKey("dbo.ReleaseGroups", t => t.ReleaseGroupCode)
                .ForeignKey("dbo.ReleaseStatus", t => t.ReleaseStatusCode)
                .ForeignKey("dbo.LeaveApplications", t => new { t.LeaveApplications_YearMonth, t.LeaveApplications_LeaveAppId })
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.ReleaseStrategyLevels", new[] { "ReleaseGroupCode", "ReleaseStrategy" }, "dbo.ReleaseStrategies");
            ...
            DropForeignKey("dbo.LeaveApplicationDetails", new[] { "CompCode", "WrkGrp", "LeaveTypeCode" }, "dbo.LeaveTypes");
            ...
            DropForeignKey("dbo.LeaveApplications", new[] { "CompCode", "WrkGrp", "UnitCode", "DeptCode", "StatCode" }, "dbo.Stations");
            DropForeignKey("dbo.LeaveApplications", new[] { "ReleaseGroupCode", "ReleaseStrategy" }, "dbo.ReleaseStrategies");
            ...
            DropForeignKey("dbo.LeaveApplications", new[] { "CompCode", "WrkGrp", "UnitCode", "DeptCode" }, "dbo.Departments");
            ...
            DropForeignKey("dbo.ApplReleaseStatus", new[] { "LeaveApplications_YearMonth", "LeaveApplications_LeaveAppId" }, "dbo.LeaveApplications");
            ...
            DropForeignKey("dbo.Employees", new[] { "CompCode", "WrkGrp", "UnitCode", "DeptCode", "StatCode" }, "dbo.Stations");
